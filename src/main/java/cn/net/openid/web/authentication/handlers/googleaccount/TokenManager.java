 ...
 * in-memory. This is just for the purposes of the sample. Ideally, the token
 * should be stored in a database with the same security restrictions as other
 * sensitive material like user passwords. Google limits the number of AuthSub
 * tokens generated per user per target and thus the tokens have to be stored
 * permanently and reused.
 * 
 * 
 */
